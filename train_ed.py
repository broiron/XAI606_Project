...
def render_test(args):
    ...
    #test_dataset = dataset(args.datadir, args.feature_dir, split='test', downsample=args.downsample_train, is_stack=True, hold_every=8)

    # all_dataset = dataset(args.datadir, args.feature_dir, split='all', downsample=args.downsample_train, is_stack=True, hold_every=8)
    ...
    if args.render_train:
        ...
        train_dataset = dataset(args.datadir, args.feature_dir, mask_path,split='train', downsample=args.downsample_train, is_stack=True)
